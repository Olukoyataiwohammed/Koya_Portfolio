...
const Home = () => {
  ...
  return (
    <div id='portfolio_homePage' style={{ padding: "20px" }}>
      ...
      {/* HERO SECTION */}
      <section className="first_section" style={{ marginBottom: "0px",marginTop: "0px" }}>
        <img className='imag ' src={images} alt="#"/>
        <div className=" sect text-black">
          <h4 className="section_header ">
            {about ? (<>Hi, <br/> I'M {about?.full_name}</>) : "No data"}
          </h4>
          <p className="section_bio " style={{width: "400px",padding :"10px" }}>{about?.bio}</p>
        </div>
      ...
      <section>
        ...
        <div
          style={{
            ...
            gap: "20px",border: "solid thin black"
          }}
        >
          {wantedProject.length > 0 ? (
            wantedProject.map((project) => (
              ...
              >
                ...
                {project.live_link && (
                  <a style={{textDecoration: "none",color:"black"}} href={project.live_link} target="_blank" rel="noreferrer">
                    View Project
                  </a>
                )}
              </div>
